...
class ConnectFrame(MainFrame.MainFrame):
    ...
    def __init__(self, master):
        ...
        self.port_combo_box = CommonCTkComboBox.CommonCTkComboBox(master=self, width=250, command=self.pick_port)
        self.port_combo_box.grid(row=0, column=1, sticky='w', padx=10, pady=(20, 10))
        self.update_ports()
